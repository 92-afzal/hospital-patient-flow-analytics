...
spark.conf.set(
  ...
  dbutils.secrets.get(scope = "vault", key = "<storage_connection>")
)


# Paths
silver_path = "abfss://<silver_container>@<storage_acct>.dfs.core.windows.net/patient_flow"
gold_dim_patient = "abfss://<gold_container>@<storage_acct>.dfs.core.windows.net/dim_patient"
gold_dim_department = "abfss://<gold_container>@<storage_acct>.dfs.core.windows.net/dim_department"
gold_fact = "abfss://<gold_container>@<storage_acct>.dfs.core.windows.net/fact_patient_flow"
